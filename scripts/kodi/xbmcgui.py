...
class ListItem(object):
	...
	def getduration(self):
		...
		"""
		return self.infos['duration'] if 'duration' in self.infos else None
	...
	def setArt(self, dictionary):
		...
		* landscape : string - image filename
		...
		"""
		self.setProperty('art', dictionary)
	...
	def setSubtitles(self, subtitleFiles):
		...
		"""
		self.setProperty('subtitle', subtitleFiles)
...
class Dialog(object):
	...
	def input(self, heading, default='', type=INPUT_ALPHANUM, option=0, autoclose=0):
		...
		if options in [xbmcgui.PASSWORD_VERIFY, xbmcgui.ALPHANUM_HIDE_INPUT] or type == xbmcgui.INPUT_PASSWORD:
			...
			secure = False
		return _xbmc.bridge.inputdialog(striptags(heading), secure=secure)	
...
class DialogProgress(object):
	...
	def iscanceled(self):
		...
		return _xbmc.bridge.isprogresscanceled()
