...
class source:
	...
	def tvshow(self, imdb, tvdb, tvshowtitle, year):
		print 'Calling dizibox tvshow with {}, {}, {}, {}'.format(imdb, tvdb, tvshowtitle, year)
		try:
	...
	def episode(self, url, imdb, tvdb, title, premiered, season, episode):
		print 'Calling dizibox episode with {}, {}, {}, {}, {}, {}, {}'.format(url, imdb, tvdb, title, premiered, season, episode)
		try:
			if url == None: return
	...
	def sources(self, url, hostDict, hostprDict):
		print 'Calling dizibox sources with {}, {}, {}'.format(url, hostDict, hostprDict)
		try:
			sources = []
