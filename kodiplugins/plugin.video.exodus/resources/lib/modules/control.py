...
lang = xbmcaddon.Addon(id='plugin.video.exodus').getLocalizedString

lang2 = xbmc.getLocalizedString

setting = xbmcaddon.Addon(id='plugin.video.exodus').getSetting

setSetting = xbmcaddon.Addon(id='plugin.video.exodus').setSetting
...
addonInfo = xbmcaddon.Addon(id='plugin.video.exodus').getAddonInfo
